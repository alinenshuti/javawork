...
public class Account {
    public static void main(String[] args) {
        ...
        System.out.println("mothly salary of emplyee is:");
        System.out.println(monthlyemployee);
        System.out.println("put the weekly employee gloss salary");
        ...
        System.out.println("weekly salary of employee is: ");
        ...
        System.out.println("enter hour employee worked");
